...
//@ComponentScan(basePackages = "com.niit", excludeFilters = @Filter(type = FilterType.ANNOTATION, value = AppConfig.class))
...
public class ApplicationContextConfig {
	...
	public DataSource getDataSource(){
		...
		dataSource.setUsername("hr");		//specify the db_username...
